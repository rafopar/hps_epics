...
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=0")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=3")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=5")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=6")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=7")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=8")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=9")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=10")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=11")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=16")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=20")
dbLoadRecords("db/svt_scan_scaler_macro.db","FIFO=32768, CHAN=24")
